...
if page == "🏠 Browse Courses":
    ...
    with col2:
        ...
        country_filter = st.multiselect("Filter by Country", sorted(all_countries), default=[])
    ...
    with col4:
        ...
        duration_filter = st.multiselect("Filter by Duration", sorted(all_durations), default=[])
    
    with col5:
        search_query = st.text_input("🔍 Search Colleges", "")
